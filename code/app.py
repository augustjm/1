...
@st.cache_data
def load_data():
    geo_df = gpd.read_file(r"C:\Users\marcu\project_1\data\DengueClustersGEOJSON.geojson")
    kml_df = read_kml_revised(r"C:\Users\marcu\project_1\data\DengueClustersKML.kml")
